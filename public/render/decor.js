...
/* L AMER PREND LE STYLE DU LIEU OU IL TOMBE, pas celui de la camera. Sa POSITION
...
export function drawGrid() {
  ...
  // LA GRILLE SUIT LA CAMERA : elle peint la vue entiere, donc elle ne peut pas
  // etre par cellule sans se couper en quatre a chaque frontiere.
  (GRILLE[biomeKey()] ?? grilleFranche)(gfx <= GFX_LOW ? 1 : 0.5);
