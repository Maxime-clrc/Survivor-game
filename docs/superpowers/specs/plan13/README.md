...
Neuf plans. **L'ordre d'exécution est celui des lots**, plus bas — pas celui des
numéros de fichier.
...
| **08** | [identité de tir](08-IDENTITE-DE-TIR.md) | laser, dispersion de l'assaut, formes de projectile |
| **09** | [Tisseur](09-TISSEUR.md) | les nœuds portent l'annonce des grappes |
| **—** | [exécution](EXECUTION.md) | les lots traduits en neuf sessions Claude Code |
...
| **13** | canon laser | test | portée hors écran, chaleur gratuite, allumage muet |
| **14** | canon d'assaut | test | la rampe ne se lit pas dans le tir |
| **15** | formes de projectile | test | 5 armes partagent la même capsule |
| **16** | nœuds du Tisseur | test | l'annonce promet une éclosion qui n'arrive jamais |

Dix viennent du test, six d'un audit du dépôt. **11 est le plus lourd** — c'est
...
| 4 | **13** | le laser : portée à 0,9, chaleur qui monte à vide, allumage et terminus |
| 5 | **14** | l'assaut : la dispersion se resserre avec `armeRes` |
| 6 | **15** | une forme de projectile par arme, et la scission du fusil à dispersion |

**13, 14 et 15 sont dans le lot 4 et pas dans le lot 7**, malgré leur apparence
cosmétique. Les trois **changent la valeur mesurée** : une portée divisée par
deux, une gerbe qui s'ouvre en mouvement, un projectile qui ne se scinde qu'à
150 px. Les faire après la campagne obligerait à la rejouer.
...
| 2 | **16** | les nœuds du Tisseur : annonce propre, empreinte de la zone future, amarres |
