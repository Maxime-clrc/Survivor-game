...
| l'arme est MUETTE (saturée, ou en recharge) | `ETAT_MUET` (64), même masque. `armeRes` ne peut pas le dire : pendant les 1,5 s de mutisme la chaleur **redescend**, donc la jauge quitte le haut au moment où elle devrait crier — et une gâchette relâchée donne les mêmes valeurs | l'anneau de chaleur qui **bat** (`render/boss.js`) |
