...
export class GameState {
  ...
  constructor(difficulty = DIFF_NORMAL, biomeIndex = null, seed = null,
    ...
    /* UN THEME PAR CARTE, ET IL EST TOUJOURS REEL. `null` en tire un — le
       comportement des scripts de mesure ; un index le force, ce que fait
       `BIOME=` et ce dont vivent tous les verificateurs par theme. */
